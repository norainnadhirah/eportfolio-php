...
$sql="update tblassessment set deleted='0' where ID=:rid";
$query=$dbh->prepare($sql);
$query->bindParam(':rid',$rid,PDO::PARAM_STR);
$query->execute();
 echo "<script>alert('Assessment is restored');</script>"; 
...
<html lang="en">
     <head>
        ...
        <title>PutraMD E-Portfolio | Deleted Assessments</title>
        ...
        <?php include_once('include/sidebar.php');?>
                   ...
                   <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Deleted Assessment</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Deleted Assessment</li>
                         ...
                         <div class="col-xl-3 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    ...
                                    <div class="card-body"><i class="fas fa-add me-1"></i><b>Deleted Assessment</b></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    ...
                                    <div class="card-body"><b>View All Assessments</b></div>
                                  <a class="small stretched-link" href="manageassessment.php"></a>
                                </div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>   
                                        <?php
                                        $sql="SELECT tblprogram.ProgramName as coursename, tblprogram.ID, tblassessment.AssessmentName, tblassessment.NumberofAssessment FROM tblassessment JOIN tblprogram on tblprogram.ID=tblassessment.IDProgram WHERE tblassessment.deleted='1'";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        <td>
                                                        ...
                                                        <span><a href="deletedassessment.php?delid=<?php echo ($row->ID);?>"  onclick="return confirm('Do you want to restore assessment ?');"><i class="fa-solid fa-trash-can-arrow-up"></i></a></span>
