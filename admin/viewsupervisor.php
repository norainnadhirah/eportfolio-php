        ...
        <?php include_once('include/sidebar.php');?>
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Manage Supervisor User</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active"><a href="manageuser.php">Manage User</a></li>
                            <li class="breadcrumb-item active">Manage Supervisor</li>
                        </ol>
                        <div class="row">
    ...
    ?>
                                             ...
                                             <td>
                                               <span><a href="edit-user.php?editid=<?php echo htmlentities ($row->userid);?>"><i class='fas fa-pen' title="edit user"></i></a></span>
                                                        <span><a href="viewsupervisor.php?delid=<?php echo ($row->userid);?>"  onclick="return confirm('Do you really want to Delete ?');" title="delete user?"><i class="fa fa-trash"></i></a></span>
