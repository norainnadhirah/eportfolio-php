...
$sql_info = "SELECT * from user where username=:idstudent";
$query = $dbh -> prepare($sql_info);
        ...
        <?php include_once('include/sidebar.php');?>
                   ...
                   <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h2 class="mt-4"><?php echo $name; ?> Assessments</h2>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                
                            <li class="breadcrumb-item active"><a href="student-assessments.php">List of Assessments  </a></li>
                             <li class="breadcrumb-item active">Student's Assessments  </a></li>
                        </ol>
                            ...
                            <div class="col-xl-12 ">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center ">
                                        <h5 class="card-title"><div class="d-flex justify-content-start "> Assessments submit by <?php echo $name; ?>  <div></h5>  </div>
...
<table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>   
                                        <?php
                                        $sql="SELECT tblsubmit_ass.*, user.name, tblsubmit_ass.Status as ass_status, tblprogram.*
FROM tblsubmit_ass
JOIN user ON user.username = tblsubmit_ass.IDStudent
JOIN tblprogram ON tblsubmit_ass.IDProgram = tblprogram.ID
WHERE tblsubmit_ass.IDStudent=:idstudent AND tblsubmit_ass.Status IS NOT NULL AND tblsubmit_ass.Status <> 0 AND tblprogram.StartDate <= CURDATE() AND tblprogram.EndDate >= CURDATE()
";
...
echo htmlentities($timeStamp3); ?></td>
  ...
  <?php if ($row->ass_status == 1 || $row->ass_status == 2) { ?>
    <span><a href="evaluate-assessment.php?SubmitID=<?php echo htmlentities ($row->ID);?>"><i class='fas fa-pen'></i></a></span>
  <?php } elseif ($row->ass_status == 3) { ?>
    <span><a href="view-assessment.php?SubmitID=<?php echo htmlentities ($row->ID);?>"><i class='fas fa-eye'></i></a></span>
  <?php } ?>
