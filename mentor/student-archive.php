                   ...
                   <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="student-profile.php">Student Profile</a></li>
...
?></h6>
 ...
 ?> - <?php echo "End date: " .date("d/m/Y", strtotime($row->EndDate)); ?></h6>
                                  ...
                                  <?php
$idstudent=$_GET['id'];
$sql = "SELECT  tblassessment.*, tblassessment.ID AS IDAss
FROM  tblassessment
WHERE tblassessment.IDProgram=:idprogram";
$query = $dbh -> prepare($sql);
//$query->bindParam(':idstd',$idstudent,PDO::PARAM_STR);
